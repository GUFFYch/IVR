...
5. Пользователь вводит имя и фамилию, которые будетут использоваться в системе
...
9. Если все введённые данные соответствуют требованиям регистрации, система приветствует пользователя и переходит в диалог выбора режима работы и тарифного плана.
...
3. После успешной варификаии по номеру телефона у пользователя открывается одельная страница настройки аккаунта
...
1. На экране появляется появляются поля ввода данных с уже заполненными полми(данные берутся из того, что пользователь уже ввел заранее)
